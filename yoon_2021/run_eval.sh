...
CUDA_VISIBLE_DEVICES=0 python3 eval_tta.py --dataset cifar10 $data_path --n_ex 1000 --batch_size 1000 $model_dir --config ./configs/cifar10_bpda_eot_sigma025_eot15.yml --eot_test 200 --attack apgd --loss cw --n_iter 10 --sigma_def .25 --max_iters_def 10 --model Standard --indices 0-45 $ebm_dir
